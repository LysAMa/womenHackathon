...
?>
				...
				<ul>
					...
					<li data-transition="3dcurtain-vertical" data-slotamount="10" data-masterspeed="300">
						...
						<li data-transition="turnoff" data-slotamount="1" data-masterspeed="300">
							...
							data-speed="600"
							data-start="1200"
							data-easing="easeOutExpo" data-end="7000" data-endspeed="300" data-endeasing="easeInSine"><span> ChwaPaN'</span></div>						
		...
		<div id="content">
			...
			<div class="welcome-box">
				<div class="container">
					<h1>Bienvenue sur <span>ChwaPaN'</span></h1><br/>
					<h4 align="center">Chwa pa nou, pou avni nou</h4>
				</div>
			</div>
					...
					<div class="upper-box">
						<div class="row">
							<div class="col-md-10" id="text" >
								...
								<h3>But de ce guide de planification familiale</h3>
								<p>
